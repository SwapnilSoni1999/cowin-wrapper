...
(async () => {
    ...
    // try {
    //     await cowin.addBeneficiary({ name: 'Swapnil', birth_year: '1965', gender_id: 1, photo_id_type: 1, photo_id_number: '6969' }, token)
    // } catch (err) {
    ...
    try {
        const appointmentId = await cowin.schedule(token, { beneficiaries: [benef[+di - 1].beneficiary_reference_id], slot: '03:00PM-06:00PM', session_id: 'b342c4dc-9d0c-45de-aed2-b1fcf015a0c9', dose: 1 })
